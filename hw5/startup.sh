...
echo "Starting HW5 VM startup script..."

apt-get update -y
DEBIAN_FRONTEND=noninteractive apt-get install -y python3-pip

pip3 install google-cloud-storage google-cloud-logging mysql-connector-python google-auth==2.23.0 --break-system-packages
...
Environment="DB_PASS=hw5password123"
Environment="DB_NAME=hw5"
