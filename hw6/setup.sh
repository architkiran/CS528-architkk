...
echo "[1/5] Starting Cloud SQL instance..."
...
echo "[2/5] Updating Cloud SQL authorized networks..."
...
echo "[3/5] Uploading scripts to GCS..."
...
# ---- Step 4: Create ML VM ----
echo "[4/5] Creating ML VM: $VM_NAME..."
...
# ---- Step 5: Wait then print results ----
echo "[5/5] Waiting for completion (checking every 30s, max 20min)..."
